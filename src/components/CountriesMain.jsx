...
export function CountryMain() {
  return (
    <div className="flex flex-col items-center text-white justify-center gap-[35px] p-10">
      <img src="/logo-white.png" alt="Olympics logo" /> {/* Добавьте alt текст */}
      ...
      <div className='flex flex-col items-start gap-5'>
        ...
        <button className='w-[300px] flex items-center justify-center gap-3 p-4 border-2 border-white rounded-xl text-lg font-semibold shadow-md bg-gray-800 bg-opacity-50'>
